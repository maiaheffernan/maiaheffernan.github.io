# Plots from the first few days of telemetry and initial results from the ADCP and CTD transecting

Everything has been deployed in Penn Cove! There are a few small maitenance things we need to go back and do before the first monthly visit later this month, but overall the deployment went really well. 
...
### Wire walker north, SWIFT 18

<figure>
  <img src="/_figures/SWIFT18_telemetry_deploymentToJun1.png" alt="Description of image">
  <figcaption>Figure 1. Telemetry mega plot from the deployment until now.</figcaption>
</figure>

### LoveJoy north, SWIFT 27

<figure>
  <img src="/_figures/SWIFT27_telemetry_deploymentToJun1.png" alt="Description of image">
  <figcaption>Figure 2. Telemetry mega plot from the deployment until now.</figcaption>
</figure>



<figure>
  <img src="/_figures/PennCove_LoveJoy north_tempSalDO.png" alt="Description of image">
  <figcaption>Figure 3. Temperature, conductivity, and dissolved oxygen from the SWIFT telemetry.</figcaption>
</figure>
...
<figure>
  <img src="/_figures/SWIFT26_telemetry_deploymentToJun1.png" alt="Description of image">
  <figcaption>Figure 4. Telemetry mega plot from the deployment until now.</figcaption>
</figure>



<figure>
  <img src="/_figures/PennCove_Inner north_tempSalDO.png" alt="Description of image">
  <figcaption>Figure 5. Temperature, conductivity, and dissolved oxygen from the SWIFT telemetry.</figcaption>
</figure>


### Inner south, SWIFT 29

<figure>
  <img src="/_figures/SWIFT29_telemetry_deploymentToJun1.png" alt="Description of image">
  <figcaption>Figure 6. Telemetry mega plot from the deployment until now.</figcaption>
</figure>



<figure>
  <img src="/_figures/PennCove_Inner south_tempSalDO.png" alt="Description of image">
  <figcaption>Figure 7. Temperature, conductivity, and dissolved oxygen from the SWIFT telemetry.</figcaption>
</figure>




### LoveJoy south, SWIFT 28

<figure>
  <img src="/_figures/SWIFT28_telemetry_deploymentToJun1.png" alt="Description of image">
  <figcaption>Figure 8. Telemetry mega plot from the deployment until now.</figcaption>
</figure>



<figure>
  <img src="/_figures/PennCove_LoveJoy south_tempSalDO.png" alt="Description of image">
  <figcaption>Figure 9. Temperature, conductivity, and dissolved oxygen from the SWIFT telemetry.</figcaption>
</figure>




### Wire walker south, SWIFT 09


<figure>
  <img src="/_figures/SWIFT09_telemetry_deploymentToJun1.png" alt="Description of image">
  <figcaption>Figure 10. Telemetry mega plot from the deployment until now.</figcaption>
</figure>
